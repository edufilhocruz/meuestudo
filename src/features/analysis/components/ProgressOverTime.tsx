...
const PerformanceChart = () => (
    <svg fill="none" height="150" viewBox="0 0 475 150" width="100%" xmlns="http://www.w3.org/2000/svg">
        <defs><linearGradient id="chart-gradient" x1="0" y1="0" x2="0" y2="100%"><stop offset="0%" stopColor="hsl(var(--primary))" stopOpacity="0.3"></stop><stop offset="100%" stopColor="hsl(var(--primary))" stopOpacity="0"></stop></linearGradient></defs>
