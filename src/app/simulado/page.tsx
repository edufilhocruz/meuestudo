  ...
  return (
    <div className="relative flex min-h-screen flex-col bg-background font-body text-foreground">
      ...
      <main className="flex-grow">
        <div className="flex justify-around border-b bg-card py-6 text-center">
          <div>
            <p className="text-3xl font-bold text-card-foreground">01<span className="text-lg">:</span>23<span className="text-lg">:</span>45</p>
